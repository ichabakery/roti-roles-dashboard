...
-- Drop problematic trigger functions that cause duplicates
...
-- Remove auto-production functions that cause duplicates 
DROP FUNCTION IF EXISTS public.auto_create_production_requests();
DROP FUNCTION IF EXISTS public.process_preorder_items();
DROP FUNCTION IF EXISTS public.create_production_requests_from_order_items();
...
-- Clean up duplicate production requests for testing
