...
DROP POLICY IF EXISTS "Users can view stock adjustments for their branch" ON public.stock_adjustments;
DROP POLICY IF EXISTS "Users can create stock adjustments for their branch" ON public.stock_adjustments;

-- Create new policies
CREATE POLICY "Users can view stock adjustments for their branch"
...
CREATE POLICY "Users can create stock adjustments for their branch"
