-- Drop the existing production trigger to fix the order creation issue
DROP TRIGGER IF EXISTS create_production_trigger_safe ON orders;

-- Create a safer version that doesn't block order creation
